...
leaderboardRouter.get('/', async (_request: Request, response: Response) => {
  try {
...
leaderboardRouter.get('/:id', async (request: Request, response: Response) => {
  try {
...
leaderboardRouter.post('/', async (request: Request, response: Response) => {
  try {
...
leaderboardRouter.put('/:id', async (request: Request, response: Response) => {
  try {
    const { teamId, score } = request.body
...
leaderboardRouter.delete('/:id', async (request: Request, response: Response) => {
  try {
